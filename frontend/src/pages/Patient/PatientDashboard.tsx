    ...
    <div className="bg-[#F8FAFC] min-h-screen pb-20 font-sans selection:bg-blue-100 selection:text-blue-900">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-10">
        ...
        <section className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <Link to="/patient/doctors" className="group inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-2xl shadow-[0_8px_20px_rgb(37,99,235,0.24)] hover:shadow-[0_12px_24px_rgb(37,99,235,0.32)] hover:-translate-y-0.5 transition-all duration-300 active:translate-y-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
                ...
                <div className="p-8 md:p-10 relative z-10">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Link to={`/patient/appointments/${nextAppt.id}`} className="px-6 py-3 bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-200 font-bold rounded-xl transition-colors text-center">
                        View Details
                      </Link>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link to="/patient/doctors" className="group bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm hover:shadow-[0_20px_40px_rgb(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="pt-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link to="/patient/doctors" className="px-5 py-2.5 bg-slate-100 rounded-full text-sm font-bold text-slate-600 hover:bg-slate-200 transition-colors">
                  View All &rarr;
                </Link>
              </div>
            </div>
              ...
              <div className="relative z-10">
                ...
                {nextAppt?.ai_pre_summary && !nextAppt.ai_pre_summary.error && (
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/10 mb-6">
                    ...
                    <Link to={`/patient/appointments/${nextAppt.id}`} className="block w-full py-2 bg-indigo-500 hover:bg-indigo-600 rounded-xl text-center text-sm font-bold transition-colors">
                      View AI Analysis
                    </Link>
                  </div>
                )}
